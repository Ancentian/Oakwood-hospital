                    ...
                    <div class="card-body"><h5 class="card-title">PRESCRIPTION DETAILS</h5>
                       ...
                       <?php if($totaldue > 0){ ?>
                        ...
                        <form class="" method="post"
                              action="<?php echo base_url(); ?>queue/add_prescription_direct/<?php echo $ticket_id; ?>/<?php echo $mvt_id; ?>">
                            <div class="row">
                                ...
                                <?php foreach ($medicine as $one) { ?>
                                    <div class="position-relative row form-group col-sm-12">
                                        ...
                                        <div class="col-sm-3"><input placeholder="" type="text"
                                         value="Available: <?php echo $one['qty']; ?>"
                                        class="form-control" disabled></div>
                                        <div class="col-sm-3"><input name="presc_<?php echo $one['id']; ?>" placeholder="Prescription eg 1x3." type="text" class="form-control" required></div>
                                        <div class="col-sm-2"><input name="units_<?php echo $one['id']; ?>" placeholder="Units." type="number" max="<?php echo $one['qty']; ?>" class="form-control" required></div>
                                    </div>
