                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 alert alert-info">
                            <form method="post" action="<?php echo base_url();?>inpatient/add_observation">
                                <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <input type="submit" value="RECORD OBSERVATION" class="btn btn-success" style="margin-top: 30px;">
                                    &nbsp;
