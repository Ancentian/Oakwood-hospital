                ...
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">SCREENING DETAILS</h5>
                        ...
                        <form class="" method="post"
                              action="<?php echo base_url(); ?>radiology/edit/<?php echo $id; ?>">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <select class="form-control select" name="cat_id">
                                            ...
                                            <?php foreach ($category as $one) {?>
                                                <option value="<?php echo $one['id']?>"<?php if($one['id'] == $test['cat_id']) {echo "selected";} ?>><?php echo $one['cat_name']?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="cost" id="cost" placeholder="" value="<?php echo $test['cost']; ?>" type="number" class="form-control" >
                                    </div>
                                </div>
