            ...
            <div class="col-md-10" style="padding-top: 20px;">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">MEDICINE DETAILS</h5>
                        <hr>
                        <form class="" method="post" action="<?php echo base_url(); ?>pharmacy/add">
                            <div class="row">
                                ...
                                <div class="position-relative row form-group col-sm-6"><label for="examplePassword" class="col-sm-4 col-form-label">Cost</label>
                                    <div class="col-sm-8"><input name="cost" placeholder="" type="number" class="form-control" required></div>
                                </div>
                                <div class="position-relative row form-group col-sm-6"><label for="examplePassword"  class="col-sm-4 col-form-label">Opening
                                        Stock</label>
                                    <div class="col-sm-8"><input name="qty" placeholder="" type="number" class="form-control" required></div>
                                </div>
                                <div class="position-relative row form-group col-sm-6"><label for="examplePassword"  class="col-sm-4 col-form-label">Alert Qty</label>
                                    <div class="col-sm-8"><input name="alert_qty" placeholder="" type="number" class="form-control" required></div>
                                </div>
                                 <div class="position-relative row form-group col-sm-6"><label for="examplePassword"  class="col-sm-4 col-form-label">Discount Rate</label>
                                    <div class="col-sm-8"><input name="disc_perc" placeholder="" type="number" class="form-control" required></div>
                                </div>
                                <div class="position-relative row form-group col-sm-6"><label for="examplePassword"  class="col-sm-4 col-form-label">Expiry</label>
                                    <div class="col-sm-8"><input name="expiry" placeholder="" type="date" class="form-control" required></div>
                                </div>
