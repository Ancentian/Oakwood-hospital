        ...
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/finance/edit_product/<?php echo $id;?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" type="text" class="form-control"  value="<?php echo $thisproduct['name'];?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control searchable" name="acc_no" required>
                                        ...
                                        <option value="<?php echo $one['id'];?>" <?php if($one['id'] == $thisproduct['acc_no']) echo "selected"; ?>><?php echo $one['acc_name'];?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" required>
                                        <option value="">--Select one</option>
                                        <option value="Product" <?php if($thisproduct['type'] == "Product") echo "selected"; ?>>Product</option>
                                        <option value="Service" <?php if($thisproduct['type'] == "Service") echo "selected"; ?>>Service</option>
                                    </select>
                                ...
                                <tbody>
                                    ...
                                    foreach ($products as $type) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <a href="#" data-toggle="popover" class="detail_popover"><?php echo $type['qty'] ?></a>
                                            </td>
                                            <td class="mailbox-name">
