        ...
        <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/finance/coa"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                               ...
                               <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" required>
                                        ...
                                        <option value="<?php echo $one['id'];?>"><?php echo $one['type_name'];?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="is_or_bs" required>
                                        <option value="">--Select one</option>
                                        <option value="is">Income Statement Account</option>
                                        <option value="bs">Balance Sheet Account</option>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive">
                            <table class="table table-striped table-bordered table-hover example"  data-ordering="false" cellspacing="0"
                       width="100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
