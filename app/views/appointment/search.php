            ...
            <div class="col-md-10" style="padding-top: 20px;">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">SEARCH PATIENT</h5>
                        <hr>
                        <form class="" method="post" action="<?php echo base_url(); ?>appointment/select">
                            <div class="row">
                                <div class="position-relative row form-group col-sm-12">
                                    <p style="padding-left: 25px;">Search by name, patient number or phone number</p>
                                </div>
                                ...
                                <div class="position-relative row form-group col-sm-6"><label for="exampleEmail"
                                    ...
                                    <div class="col-sm-8"><input name="phone" id="exampleEmail" placeholder=""
                                                                 type="text" class="form-control"></div>
                                </div>
                                <div class="position-relative row form-group col-sm-6"><label for="exampleEmail"
                                                                                              class="col-sm-4 col-form-label">Patient
                                        Number</label>
                                    <div class="col-sm-8"><input name="patient_no" id="exampleEmail" placeholder=""
                                                                 type="text" class="form-control"></div>
                                </div>
